...
class PublishingHouseForm extends Component {
    ...
    handleChange = e => {
        ...
        if (name === 'name') {
            errors.name =
                value.length < 2
                    ? "Name of publishing house must be at least 2 characters long!"
                    : '';
        } else {
        }
    ...
    handleSubmit = e => {
        ...
        if (this.validateForm(this.state.errors)) {
            axios
                .post('/api/publishinghouse', this.state.data )
                .then(() => {
                    this.setState({
                        data: {
                            name: ""
                        ...
                        errors: {
                            message: "New publishing house was saved",
                            name: ""
                        }
                    });
                })
